...
3. **Custom Artifact Contracts:** User-defined contracts under `/docs/artifacts/`, usually extending a known base type. `CUSTOM_TYPE.yaml` is scaffolded as a learning example of this level.
